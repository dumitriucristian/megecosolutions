...
export const siteContentEn = {
  ...
  ui: {
    ...
    viewB2gApplications: "View B2G applications",
    allRightsReserved: "All rights reserved.",
    sitemap: "Sitemap",
    robots: "Robots",
    homeEyebrow: "Municipal waste management • Energy resilience",
    homeHighlightsTitle: "Designed for B2G performance and accountability",
    homeHighlightsIntro:
      "Regulatory clarity, measurable outcomes, and integration into existing municipal logistics — engineered for real-world operation.",
    aboutPillarsTitle: "Institutional pillars",
    marketsIntro:
    ...
    contactAsideIntro: "Prefer email? We respond from a monitored institutional inbox.",
    contactEmailLabel: "Email",
    contactTeamLabel: "Team",
    contactCompanyLabel: "Company",
    formRequired: "Required",
    formInvalidEmail: "Enter a valid email",
    formSending: "Sending…",
    formSubmit: "Submit inquiry",
    formSuccessTitle: "Thanks — we’ve received your inquiry.",
    formSuccessBody:
      "Our team will review your message and respond promptly. All inquiries are treated with absolute confidentiality.",
    formErrorGeneric: "Something went wrong. Please email {email} directly.",
    formErrorNetwork: "Unable to reach the server. Please email {email} directly.",
    formSelectPlaceholder: "Select an inquiry type",
    formConfidentiality: "All initial inquiries are treated with absolute confidentiality.",
  },
  ...
  pages: {
    ...
    contact: {
      title: "Contact",
      description:
        "Start the conversation. Confidential, structured inquiry for B2G and institutional projects.",
    },
  },
  ...
  contact: {
    ...
    company: {
      ...
      address: ["ÖSTERVÄGEN 23", "196 41 KUNGSÄNGEN", "Sweden"],
...
export type SiteContent = WidenStrings<typeof siteContentEn>;
